      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Finde unabhängige Solar-Profis in deiner Region
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cities.map((city, index) => (
            <Card key={index} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <div className="relative overflow-hidden rounded-t-lg cursor-pointer" onClick={() => window.location.href = `/solaranlage/${city.slug}`}>
                <img 
                  src={city.image}
                  alt={`Solaranlage ${city.title}`}
              ...
              <CardContent className="p-6">
                ...
                <Button 
                  ...
                  onClick={() => window.location.href = `/solaranlage/${city.slug}`}
                >
                  Mehr erfahren
        ...
        {showAllButton && (
          <div className="text-center mt-10">
            <Button 
              ...
              onClick={() => window.location.href = '/solaranlage'}
            >
